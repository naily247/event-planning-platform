...
export function VendorWorkspaceNav() {
  return (
    <div className="sticky top-3 z-40">
      <nav
        className="glass-card overflow-x-auto p-3 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
        ...
        <div className="flex w-max min-w-full items-center justify-between gap-2">
          {vendorWorkspaceSections.map(({ label, to, icon: Icon }) => (
            <NavLink
              ...
              className={({ isActive }) =>
                [
                  'soft-chip relative shrink-0 snap-start whitespace-nowrap text-sm font-bold',
