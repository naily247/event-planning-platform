  ...
  return (
    <div className="relative overflow-hidden rounded-[2rem] border border-white/62 bg-white/34 p-6 shadow-[0_28px_90px_rgba(31,27,29,0.10)] backdrop-blur-2xl sm:p-8">
      ...
      <div className="relative">
        <div className="soft-chip mb-5 w-fit text-xs font-black uppercase tracking-[0.24em] text-[var(--color-deep-plum)]">
        ...
        <p className="mt-4 max-w-lg text-sm font-medium leading-7 text-[var(--color-charcoal)]/66 sm:text-base">
          Continue planning, review vendor activity and keep every important event detail connected
          in one place.
        </p>

        <form className="mt-7 grid gap-5" onSubmit={onSubmit} noValidate>
          <label className="block">
            <span className="mb-2 block text-sm font-black text-[var(--color-charcoal)]/74">
              Email address
            </span>
        ...
        <div className="mt-6 flex flex-col items-center justify-between gap-3 border-t border-[var(--color-charcoal)]/8 pt-5 sm:flex-row">
